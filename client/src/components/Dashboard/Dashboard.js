      ...
      <main className="main-content">
        ...
        <div className="stats-grid">
          <div className="stat-card dark">
            ...
            <div className="stat-change positive">+6.2% since last month</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">⬇️</div>
            <div className="stat-label">Total Income</div>
            <div className="stat-value">₹85,000</div>
            <div className="stat-change positive">+6.2% since Jan</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">⬆️</div>
            <div className="stat-label">Total Expenses</div>
            <div className="stat-value">₹85,000</div>
            <div className="stat-change negative">-2.1% decreased</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">🐷</div>
            <div className="stat-label">Net Savings</div>
            <div className="stat-value">₹45,800</div>
            <div className="stat-change positive">+8.5% efficiency</div>
          </div>
        </div>
          ...
          <div className="right-sidebar">
            <div className="insights-section">
              ...
              <div className="insight-item">
                <div className="insight-date">07/12/2025</div>
                <div className="insight-text">Subscription optimization: Cancel unused Adobe Creative to save $50/mo.</div>
              </div>
              <div className="insight-item">
                <div className="insight-date">06 JAN</div>
                <div className="insight-text">Tax deadline approaching in 15 days. Prepare your W2 forms.</div>
              </div>
            </div>
